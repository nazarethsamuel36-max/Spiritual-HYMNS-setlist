    ...
    <div className="relative flex items-center">
      ...
      {open && (
        <>
          ...
          <div className="absolute top-7 left-0 z-50 min-w-[180px] overflow-hidden rounded-2xl border border-slate-100 bg-[var(--color-surface)] shadow-[0_4px_14px_rgba(15,23,42,0.10)] animate-in fade-in zoom-in-95 duration-150">

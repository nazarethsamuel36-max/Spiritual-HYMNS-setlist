  ...
  return (
    <div className="relative">
      <button
        ...
        className="px-3 py-1.5 h-9 bg-[var(--color-surface)] border border-slate-200 rounded-lg shadow-sm hover:bg-slate-50 text-slate-600 text-xs font-bold transition-all flex items-center space-x-1.5 active:scale-95"
      >
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-48 bg-[var(--color-surface)] border border-slate-200 rounded-xl shadow-xl z-50 animate-in fade-in slide-in-from-top-2 p-2">

...
export function ReaderHeader({
  ...
  return (
    <div className="flex-shrink-0 bg-[#FAFAFA]/95 backdrop-blur-md border-b border-slate-200/60 z-40 relative px-4 md:px-8 py-1.5 md:py-2 shadow-sm flex flex-col w-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 max-w-4xl mx-auto w-full">
        <div className="flex items-center space-x-2 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-base sm:text-lg md:text-xl font-bold text-slate-900 tracking-tight leading-tight truncate font-poppins py-0.5">
              {formatSongTitle(song.title)}
            </h1>
            <div className="flex items-center space-x-1.5 mt-0.5">
              <span className="text-slate-500 text-[10px] sm:text-xs font-semibold uppercase tracking-wider truncate">
                {song.artist || 'Unknown Artist'}
              </span>
              <span className="text-slate-300 text-[9px]">•</span>
              <span className="text-slate-500 text-[10px] sm:text-xs font-medium">#{song.songNumber}</span>
            </div>
          </div>
        </div>

        <div className="flex items-center justify-between sm:justify-end space-x-1.5 flex-shrink-0 w-full sm:w-auto">
          ...
          >
            ...
            <div className="flex items-center justify-center px-1.5 sm:px-2 border-x border-slate-100 bg-slate-50/50 min-w-[2rem] sm:min-w-[2.25rem] h-full">
